...
<section class="bg-gradient-to-b from-white to-gray-50 py-20 min-h-screen flex items-center">
    <div class="container mx-auto px-6 max-w-md">
        <h2 class="text-4xl md:text-5xl font-extrabold text-teal-900 mb-8 text-center tracking-tight drop-shadow-md">Register</h2>
        <form action="/travel-quiz/process.php" method="POST" class="space-y-6 bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300">
            <div>
        ...
        <p class="mt-6 text-center text-gray-700">
            ...
            <a href="/travel-quiz/login.php" class="text-orange-600 font-semibold hover:underline transition duration-300">Login here</a>
        </p>
    </div>
</section>
